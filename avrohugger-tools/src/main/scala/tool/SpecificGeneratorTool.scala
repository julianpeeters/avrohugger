...
class SpecificGeneratorTool extends Tool {
/**
 ...
 */
  ...
  @Override
  def getName: String = "generate-specific";

  @Override
  def getShortDescription: String = "Generates Scala code extending SpecificRecordBase.";
