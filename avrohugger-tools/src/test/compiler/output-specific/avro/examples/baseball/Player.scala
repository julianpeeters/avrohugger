...
case class Player(var number: Int, var first_name: org.apache.avro.util.Utf8, var last_name: org.apache.avro.util.Utf8, var nicknames: Seq[Nickname]) extends org.apache.avro.specific.SpecificRecordBase {
