...
class SpecificGeneratorToolSpec extends mutable.Specification {
  ...
  "match the expected dependent files" in {
    ...
    val testPlayerFile =
      if (avrohugger.internal.Version.scala == "2.13")  Directory.TEST_EXPECTED_SPECIFIC_PLAYER_213
      else if (avrohugger.internal.Version.scala == "3.3") Directory.TEST_EXPECTED_SPECIFIC_PLAYER_3
  ...
  "match the expected file and directory" in {
    ...
    def testWrestlerFile: String = {
      if (avrohugger.internal.Version.scala == "2.13") Directory.TEST_EXPECTED_SPECIFIC_WRESTLER_213
      else if (avrohugger.internal.Version.scala == "3.3") Directory.TEST_EXPECTED_SPECIFIC_WRESTLER_3
