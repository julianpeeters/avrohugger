...
`java -jar /path/to/avrohugger-tools_2.12-2.11.3-assembly.jar generate schema user.avsc . `


* `generate-specific` generates definitions that extend Avro's `SpecificRecordBase`:

`java -jar /path/to/avrohugger-tools_2.12-2.11.3-assembly.jar generate-specific schema user.avsc . `
