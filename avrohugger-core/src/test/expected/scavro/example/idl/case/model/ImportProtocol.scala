...
import other.ns.case.{ExternalDependency => JExternalDependency, Suit => JSuit}
...
final case class DependentRecord2(dependency: Suit, name: String) extends AvroSerializeable with ImportProtocol {
